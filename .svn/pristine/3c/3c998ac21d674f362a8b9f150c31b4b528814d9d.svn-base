...
/**
 * This version has separate inputs for all players owning a property. It will
 * also have the money scaled and only allow for two player games.
 * @author Chris Berry
 */
public class FourthTDPlayerVer2 extends TDInputGenerator {
    
    public static final int NUM_INPUT_NODES = 117;
    ...
    public double[] getCurrentInputs(int playerNumber) {
        ...
        for (int i = 0; i < numberOfPlayers; i++) {
            if (allPlayers.size() > i) {
                ...
                money = (Math.log(money) / Math.log(100)) - 1;
