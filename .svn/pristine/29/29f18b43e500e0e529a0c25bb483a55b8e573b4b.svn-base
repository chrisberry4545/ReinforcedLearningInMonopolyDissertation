 ...
 * @author Chris Berry
 */
public class FifthTDPlayerVer34 extends FifthTDPlayerVer31 {
    
    public static final int NUM_INPUT_NODES = 181;
    public static final int NUM_OUTPUT_NODES = 1;
    public static final int NUM_HIDDEN_NODES = 120; 
     ...
     */
    public FifthTDPlayerVer34(boolean useDealSubsets) {
