...
/**
 * This third TD Player will not use colors as an input to the system.
 * @author Chris Berry
 */
public class ThirdTDPlayerVer6 extends TDInputGenerator {
    
    public static final int NUM_INPUT_NODES = 103;
 ...
 */    
    ...
    public double[] getCurrentInputs(int playerNumber) {
        ...
        //22 sets of 3 nodes representing properties.
