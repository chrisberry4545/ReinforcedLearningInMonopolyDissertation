...
/**
 * Same as ver 6.4 but with jail input nodes re-added.
 * @author Chris Berry
 */
public class SixthTDPlayerVer6 extends TDInputGenerator {
     ...
     */
    public SixthTDPlayerVer6(boolean useDealSubsets) {
