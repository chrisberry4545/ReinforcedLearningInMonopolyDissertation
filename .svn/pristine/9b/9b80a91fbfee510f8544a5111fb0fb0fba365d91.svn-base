...
/**
 * Same as SixthTDPlayerVer2 but with jail inputs removed.
 * @author Chris Berry
 */
public class SixthTDPlayerVer5 extends TDInputGenerator {
     ...
     */
    public SixthTDPlayerVer5(boolean useDealSubsets) {
