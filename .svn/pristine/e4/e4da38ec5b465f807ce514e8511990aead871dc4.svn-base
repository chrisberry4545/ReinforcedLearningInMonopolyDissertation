        ...
        if (this.owner != player) {
            if (!this.isMortgaged()) {
                if (this.owner != null) {
                    ...
                    player.messagePlayer("You paid Player " + owner.getNumber() 
                            + " $" + rent, "Paid rent");
                } else {
 ...
 */    
    ...
    /**
     * Mortgages a property without the player gaining money for the action.
     */
 ...
 */    
    ...
    /**
     * Gets the Re-buy rate of a property (mortgage rate + mortgage repayment rate).
     * @return Cost to Re-buy a property from mortgage.
     */
    public int getRebuyRate() {
        return getMortgageRate() + getMortgageRepaymentRate();
    }
