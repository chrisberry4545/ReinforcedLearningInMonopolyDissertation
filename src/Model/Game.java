 ...
 */    
    ...
    private static void updateInputsForTDPlayer(Player player) {
        if (player.getClass().equals(TDPlayer.class)) {
            TDPlayer tdPlayer = 
                        (TDPlayer) player;
 ...
 */    
    ...
    /**
     * Sets the round count to the given value.
     * @param roundCount the new round count to use.
     */
    public void setRoundCount(int roundCount) {
        this.roundCounter = roundCount;
    }

    /**
     * Sets the current player to the player with this token.
     * @param playerToken sets current player to this.
     */
    public void setCurrentPlayer(int playerToken) {
        for (int i = 0; i < allPlayers.size(); i++) {
            if (allPlayers.get(i).getNumber() == playerToken) {
    ...
    /**
     * Sets the current player index to the value given.
     * @param playerIndex to use.
     */
