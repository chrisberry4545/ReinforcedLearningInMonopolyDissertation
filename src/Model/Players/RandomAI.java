 ...
 */
    ...
    public boolean askPlayerMoveOptions() {
        ...
        int choice = randomOptionChoice(Player.BUY_BACK_MORTGAGED_PROPERTIES);
        switch(choice) {
    ...
    /**
     * The AI builds a house on a property.
     */
    ...
    public void sellHouses() {
        for (Space property : this.getSitesWithHousesWhichCanBeSold()) {
