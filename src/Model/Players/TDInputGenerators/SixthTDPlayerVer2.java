...
/**
 * This version uses additional nodes to try and encode when a Player is
 * one property away from obtaining a Monopoly. This doesn't use as many
 * inputs as SixthTDPlayerVer1.
 * @author Chris Berry
 */
public class SixthTDPlayerVer2 extends TDInputGenerator {
    
    public static final int NUM_INPUT_NODES = 189;
     ...
     */
    public SixthTDPlayerVer2(boolean useDealSubsets) {
 ...
 */    
    ...
    public double[] getCurrentInputs(int playerNumber) {
        ...
        for (int colorNumber = 1; colorNumber <= Board.BLUE; colorNumber++) {
            ...
            if (SiteGroup.anyPlayerIsOneOffMonopoly(colorNumber)) {
                inputs[inputNumber] = 1;
            } else {
                inputs[inputNumber] = 0;
            }
