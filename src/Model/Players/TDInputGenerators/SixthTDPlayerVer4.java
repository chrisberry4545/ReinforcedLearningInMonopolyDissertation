...
/**
 * This version uses an additional node for each of the Site Groups to tell
 * whether the player owns a Monopoly or not. This version also cuts the
 * input nodes I feel are not important to save more time (the ones involving
 * jail).
 * @author Chris Berry
 */
public class SixthTDPlayerVer4 extends TDInputGenerator {
    
    public static final int NUM_INPUT_NODES = 177;
     ...
     */
    public SixthTDPlayerVer4(boolean useDealSubsets) {
