...
public class TDPlayerHandCraftedFeatures extends TDPlayer {
     ...
     */
    public boolean playerOwningPropertiesMeansTheyHaveAMonopoly(Collection<Space> properties,
            Player playerToGivePropertiesTo) {
        boolean playerWouldHaveMonopoly = false;
        if (properties.isEmpty()) {
            return false;
        }
        Space firstSpace = (Space)properties.toArray()[0];
        Player propertyOriginalOwner = firstSpace.getOwner();
